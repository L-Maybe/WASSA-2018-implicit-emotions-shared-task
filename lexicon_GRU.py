...
if __name__ == '__main__':
    ...
    # embedded = Embedding(input_dim=max_features, output_dim=num_features, in put_length=maxlen, weights=[W], trainable=False) (sequence)
    ...
    # stacked LSTM
    # hidden = Bidirectional(LSTM(hidden_dim, recurrent_dropout=0.45, return_sequences=True))(embedded)
    # hidden = Bidirectional(LSTM(hidden_dim, recurrent_dropout=0.45))(hidden)
