...
if __name__ == '__main__':
    pickle_file = os.path.join('pickle', 'waasa2018_six_fill_target_data.pickle')
    ...
    # bi-gru
	# enc = Bidirectional(GRU(hidden_dim//2, recurrent_dropout=0.25, return_sequences=True))(convolution)
    ...
    model.fit(X_train, y_train, validation_split=0.1, batch_size=batch_size, epochs=nb_epoch, verbose=1, callbacks=[early_stopping])
    ...
    #
    # result_output.to_csv("./result/waasa2018_six_fill_target_data.csv", index=False, quoting=3)