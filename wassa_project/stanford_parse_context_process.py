...
train_data = pd.read_csv("./wassa2018_data/train_context_v3.csv", header=None, sep='\t', quoting=3)
trial_data = pd.read_csv('./wassa2018_data/trial_context_v3.csv',  header=None, sep='\t', quoting=3)
